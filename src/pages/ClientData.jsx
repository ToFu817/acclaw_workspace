...
export default function ClientData() {
  ...
  const columns = [
    { key: 'clientId', label: '客戶編號', width: '80px', fixed: 'left' },
    { key: 'companyName', label: '公司行號名稱', minWidth: '180px', fixed: 'left' },
    { key: 'orgType', label: '組織型態', width: '100px' },
    { key: 'handler', label: '承辦', width: '90px' },
    {
      key: 'status', label: '目前狀態', width: '100px',
      render: (v) => <TofuBadge color={CLIENT_STATUS_COLORS[v] || 'gray'}>{v}</TofuBadge>,
    },
    { key: 'yearNote', label: '年度註記', width: '90px' },
    { key: 'taxId', label: '統一編號', width: '100px' },
    { key: 'taxRegId', label: '稅藉編號', width: '100px' },
    { key: 'zipCode', label: '郵遞區號', width: '80px' },
    { key: 'contactAddress', label: '聯絡地址', minWidth: '200px' },
    { key: 'regAddress', label: '營業登記地址', minWidth: '200px' },
    { key: 'owner', label: '負責人', width: '90px' },
    { key: 'contactPerson', label: '聯絡人', width: '90px' },
    { key: 'mailPhone', label: '郵寄電話', width: '110px' },
    { key: 'deliveryMethod', label: '送件方式', width: '100px' },
    { key: 'pickupMethod', label: '取件方式', width: '100px' },
    { key: 'companyPhone', label: '公司電話', width: '110px' },
    { key: 'contactMobile', label: '手機', width: '110px' },
    { key: 'email', label: 'Email', minWidth: '150px' },
    { key: 'taxExt', label: '分機', width: '70px' },
    { key: 'note', label: '備註', minWidth: '200px' },
    { key: 'taxPassword', label: '稅務密碼', width: '100px' },
    { key: 'healthInsCode', label: '健保代號', width: '100px' },
  ];
